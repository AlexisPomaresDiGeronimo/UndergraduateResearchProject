...
{
    public class EntertainmentRepo : GenericRepository<Entertainment>, IEntertainmentRepo
    {
        public EntertainmentRepo(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
    }
}